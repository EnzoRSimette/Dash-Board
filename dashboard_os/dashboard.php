...
<body>
    <div class="bg-zinc-100 min-h-screen min-w-screen">
        <div id="links" class="min-w-screen bg-white h-10 border-b-2 border-sky-300">
            <div class="p-2"><a href="../dashboard_o/dashboard.php" class="bg-cyan-300 px-[8px] py-1 rounded-xl font-serif hover:shadow-[inset_0_0_20px_rgba(34,211,238,1)] focus:outline-2 focus:outline-offset-1 focus:outline-cyan-500 active:bg-cyan-600">Dashboard para os Orgãos Inferiores</a></div>
        </div>
